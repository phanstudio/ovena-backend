...
# def sample_data(db):
#     # Create addresses
#     addr1 = make_point(33.4, 56.7)#Address.objects.create(address="123 Main St", latitude=23443, longitude=67433)
#     addr2 = make_point(333.4, 56.7)#Address.objects.create(address="456 Side St", latitude=45643, longitude=67433)
