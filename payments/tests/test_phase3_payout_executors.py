"""Phase 3: payout executors (realtime and batch).

These tests ensure that:
- payout strategy is persisted alongside withdrawals;
- realtime executor hits Paystack once per withdrawal and stores transfer refs;
- batch executor only operates on batch-strategy withdrawals and fans out bulk transfers;
- final status transitions emit the right metrics for observability.
"""
