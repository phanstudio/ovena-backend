...
urlpatterns = [
    ...
    path(
        "analysis/store/",
        views.BusinessStoreAnalysisView.as_view(),
        name="business-store-analysis",
    ),
    path(
        "wallet/transaction-pin/",
        views.BusinessTransactionPinView.as_view(),
        name="business-transaction-pin",
    ),
    path("payment/", views.RestaurantPaymentView.as_view(), name="business-payment"),
    path(
        "payment/verify/",
        views.RestaurantPaymentReceiverView.as_view(),
        name="business-payment-verify",
    ),
    path(
        "wallet/balance/",
        views.BusinessWalletBalanceView.as_view(),
        name="business-wallet-balance",
    ),
    path(
        "wallet/transactions/",
        views.BusinessTransactionHistoryView.as_view(),
        name="business-wallet-transactions",
    ),
    path(
        "wallet/withdraw/eligibility/",
        views.BuisnessWithdrawEligibilityView.as_view(),
        name="business-withdrawal-eligibility",
    ),
    path(
        "wallet/withdraw/",
        views.BusinessWalletWithdrawalView.as_view(),
        name="business-wallet-withdraw",
    ),
    path(
        "wallet/withdrawals/",
        views.BusinessWalletWithdrawalHistoryView.as_view(),
        name="business-wallet-history",
    ),
    ...
    path(
        "admin/update/",
        views.BuisnessAdminUpdateView.as_view(),
        name="buis-admin-update",
    ),
    path(
        "update/",
        views.BuisnessUpdateView.as_view(),
